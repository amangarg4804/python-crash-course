...
start_eps = 139.0       # starting EPS
start_pe = 104.0        # starting P/E
eps_growth_rate = 0.25 # A% annual EPS grrowth
pe_change_rate = -0.10 # P/E multiple contracts by X% per year
years = 5              # simulate 5 years

print("Current Price: " + str(start_eps * start_pe))
